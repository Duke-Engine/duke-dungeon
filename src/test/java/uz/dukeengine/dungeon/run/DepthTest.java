...
class DepthTest {
     ...
     */
    private static void defeatTheBoss(uz.dukeengine.dungeon.Dungeon.Session session) {
     ...
     */
    private static GameObject bossOf(uz.dukeengine.dungeon.Dungeon.Session session) {
